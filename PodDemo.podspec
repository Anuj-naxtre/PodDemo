...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "anuj-naxtre"
  # spec.authors            = { "anuj-naxtre" => "anuj.naxtre@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/anuj-naxtre"
  ...
  spec.source       = { :git => "https://github.com/Anuj-naxtre/PodDemo.git", :tag => "#{spec.version}" }
